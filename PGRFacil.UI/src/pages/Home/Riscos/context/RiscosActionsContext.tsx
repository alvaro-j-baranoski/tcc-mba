...
export const RiscosActionsContextProvider = ({ children }: { children: React.ReactNode }) => {
    ...
    const memoredRiscosContext = useMemo(() => ({ modalState, handleModal }), [modalState, handleModal]);

    return <RiscosActionsContext.Provider value={memoredRiscosContext}>{children}</RiscosActionsContext.Provider>;
};
